...
while (<>) {
   ...
   if ($_ eq "") {
    ...
    ##Os termos de treetagger: etiquetar como nomes: se & = N
     if ($pal =~ /\&/) {
        $tag = "N"
     }
    ...
    # if ( (defined $tag) &&  (defined $tag2) &&  (defined $tag3) && (defined $tag4) ) {  
      if ( ($tag =~ /^V/) && ( ($tag2 =~ /^V/) || (Prep($tag2)) )   && 
           ($tag3 =~ /^V/) && ($tag4 =~ /^V/) ) {
          if ( ($lema3 =~ /^${PASIVA}$/) && ( ($tag4 =~ /^VMP/)  || ($tag4 =~ /^VBN/) || ($tag4 =~ /^VBD/) ) ) {
      ...
      elsif ( ($tag =~ /^V/) && ( ($tag2 =~ /^V/) || Prep($tag2) ) && ($tag3 =~ /^V/) ) {
          if ( ($lema2 =~ /^${PASIVA}$/) && ( ($tag3 =~ /^VMP/) || ($tag3 =~ /^VBN/) || ($tag3 =~ /^VBD/)) ) {
            $pal3 = $pal . "&" . $pal2 . "&" . $pal3 ;
          }
          else {
             $pal3 = $pal . "&" . $pal2 . "&" . $pal3 ;
      ...
      elsif ( ($lema =~ /^${AUX}$/) && ( ($tag2 =~ /^VMP/) || ($tag2 =~ /^VBD/) || ($tag2 =~ /^VBN/) ) ) {
          $pal2 = $pal . "&" . $pal2 ;
          $tag2 = $tag;
       ...
       elsif ( ($lema =~ /^${PASIVA}$/) && ( ($tag2 =~ /^VMP/) || ($tag2 =~ /^VBD/) || ($tag2 =~ /^VBN/) ) ) {
          $pal2 = $pal . "&" . $pal2 ;
         # $tag2 = $tag;
