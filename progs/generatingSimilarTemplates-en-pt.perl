...
while ($line = <STDIN>) {
    ...
    if ( ($pal1 ne "") && ($pal2 ne "") ) {
      ...
      printf "with_down_%s com_down_%s\n", $pal1, $pal2;
      printf "with_up_%s com_up_%s\n", $pal1, $pal2;

      printf "in_down_%s em_down_%s\n", $pal1, $pal2;
      printf "in_up_%s em_up_%s\n", $pal1, $pal2;

      printf "into_down_%s em_down_%s\n", $pal1, $pal2;
      printf "into_up_%s em_up_%s\n", $pal1, $pal2;

      printf "at_down_%s em_down_%s\n", $pal1, $pal2;
      printf "at_up_%s em_up_%s\n", $pal1, $pal2;
      ...
      printf "to_down_%s até_down_%s\n", $pal1, $pal2;
      printf "to_up_%s até_up_%s\n", $pal1, $pal2;
     ...
     ##contextos verbais:
      ...
      printf "iobj&in_up_%s iobj&em_up_%s\n", $pal1, $pal2;

      printf "iobj&at_up_%s iobj&em_up_%s\n", $pal1, $pal2;

      printf "iobj&into_down_%s iobj&em_down_%s\n", $pal1, $pal2;
      ...
      printf "iobj&with_up_%s iobj&com_up_%s\n", $pal1, $pal2;
      ...
      printf "iobj&in_down_%s iobj&em_down_%s\n", $pal1, $pal2;

      printf "iobj&at_down_%s iobj&em_down_%s\n", $pal1, $pal2;
      ...
      printf "iobj&to_down_%s iobj&até_down_%s\n", $pal1, $pal2;
      ...
      printf "iobj&with_down_%s iobj&com_down_%s\n", $pal1, $pal2;
